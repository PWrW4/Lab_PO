...
public class ShapeFactory {
	...
	public MyShape generateShape() {
		...
		switch (random.nextInt(4)) {
			case 0:
				return new Circle(x, y, initShapeSize);
			case 1:
				return new Rectangle(x, y, initShapeSize, initShapeSize);
			case 2:
				return new Circle(x, y, initShapeSize, initShapeSize);
			default:
				return new Rectangle(x, y, initShapeSize);
		}
	}
}
